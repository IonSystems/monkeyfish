...
public class GameScreen extends DefaultScreen implements Screen {
	...
	public GameScreen(final MonkeyFishGame gam, Table hud) {
		...
		player.generateAnimation("mario", File.getInstance().getFile("mario" + screenVersion), 5, 1);
		player.generateAnimation("mario_hurt", File.getInstance().getFile("mariohurt" + screenVersion),3, 1);
